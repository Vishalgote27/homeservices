...
const Heating_service = () => {
    ...
    const getContentForButton = (buttonId) => {
        ...
        switch (buttonId) {
            ...
            // ... Implement cases htmlFor other buttons
            default:
                return null;
        }
    };
        ...
        <div className="container">
            <div className="row">
                ...
                <div className={`col-sm-8 mt-2 ps-5`}>
                    {content}
                    <button data-bs-toggle="modal" data-bs-target="#exampleModal" type="button" className="btn btn-warning btn-lg fw-semibold fs-6 mb-5">GET SERVICE NOW</button>
                </div>
            </div>
        </div>
                ...
                <div className="modal-content">
                    ...
                    <div className="modal-body">
                        <div className="mb-3">
                            ...
                            <label htmlFor="exampleFormControlInput1" className="form-label mt-2">Your address</label>
                            <input type="email" className="form-control" id="exampleFormControlInput1" placeholder="address" />

                            <label htmlFor="exampleFormControlInput1" className="form-label mt-2">Phone</label>
                            <input type="email" className="form-control" id="exampleFormControlInput1" placeholder="91+" />
                        </div>
                    </div>
                    <div className="modal-footer">
                        <button type="button" className="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                        <button type="button" className="btn btn-primary" data-bs-dismiss="modal">Buy now</button>
                    </div>
                </div>
            </div>
        </div>
